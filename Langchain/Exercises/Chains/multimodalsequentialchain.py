...
# LLM
openai_llm = ChatOpenAI(model="gpt-4o",api_key=OPEN_API_KEY)
...
first_chain = outline_prompt_template | openai_llm | StrOutputParser()
final_chain = first_chain | introduction_prompt | mistral_llm
